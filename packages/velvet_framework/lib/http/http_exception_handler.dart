...
import 'package:velvet_framework/http/exceptions/http_request/4xx/400_bad_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/401_unauthorized_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/402_payment_required_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/403_forbidden_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/404_not_found_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/405_method_not_allowed_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/406_not_accetable_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/409_conflict_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/410_gone_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/413_payload_too_large_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/4xx/422_unprocessable_content_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/5xx/500_internal_server_error_http_request_exception.dart';
import 'package:velvet_framework/http/exceptions/http_request/5xx/502_bad_gateway_http_request_exception.dart';
