...
abstract class VelvetLoggerChannel {
  ...
  /// The [exception] parameter represents an optional exception associated with the debug message.
  ...
  /// The [exception] parameter represents an optional exception associated with the info message.
  ...
  /// The [exception] parameter represents an optional exception associated with the warning message.
  ...
  /// The [exception] parameter represents an optional exception associated with the error message.
  ...
  /// The [exception] parameter represents an optional exception associated with the critical message.
