...
class WireframeLight extends _$WireframeLight
  ...
  ThemeDefinition build() {
    return ThemeDefinition(
      ...
      surface50: const Color(0xFFFFFFFF),
      surface100: const Color(0xFFEEEEEE),
      surface200: const Color(0xFFDCE4E9),
      surface300: const Color(0xFFC5C7C9),
      surface400: const Color(0xFFABAFB3),
      surface500: const Color(0xFF79747E),
      surface600: const Color(0xFF555555),
      surface700: const Color(0xFF40484C),
      surface800: const Color(0xFF333333),
      surface900: const Color(0xFF000000),
      surfaceInverse50: const Color(0xFF000000),
      surfaceInverse100: const Color(0xFF333333),
      surfaceInverse200: const Color(0xFF40484C),
      surfaceInverse300: const Color(0xFF555555),
      surfaceInverse400: const Color(0xFF79747E),
      surfaceInverse500: const Color(0xFFABAFB3),
      surfaceInverse600: const Color(0xFFC5C7C9),
      surfaceInverse700: const Color(0xFFDCE4E9),
      surfaceInverse800: const Color(0xFFEEEEEE),
      surfaceInverse900: const Color(0xFFFFFFFF),
    );
  }
}
